...
type Config struct {
        ...
        // WhatsApp Login Configuration
        WALoginMethod    string // WHATSAPP_LOGIN_METHOD — "qr" or "pairing_code", default: "qr"
        WABotNumber      string // WHATSAPP_BOT_NUMBER — for pairing code method
...
func Load() (*Config, error) {
        ...
        cfg := &Config{
                ...
                // WhatsApp Login Configuration
                WALoginMethod: getEnvWithDefault("WHATSAPP_LOGIN_METHOD", "qr"),
                WABotNumber:   strings.TrimSpace(os.Getenv("WHATSAPP_BOT_NUMBER")),
